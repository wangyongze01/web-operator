...
func (in *HostPathMountConfig) DeepCopyInto(out *HostPathMountConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostPathMountConfig.
func (in *HostPathMountConfig) DeepCopy() *HostPathMountConfig {
	if in == nil {
		return nil
	}
	out := new(HostPathMountConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WebAppSpec) DeepCopyInto(out *WebAppSpec) {
	*out = *in
	...
	if in.HostPathMount != nil {
		in, out := &in.HostPathMount, &out.HostPathMount
		*out = make([]HostPathMountConfig, len(*in))
		copy(*out, *in)
	}
	if in.HostBinding != nil {
		in, out := &in.HostBinding, &out.HostBinding
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
